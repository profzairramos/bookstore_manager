...
public class SwaggerConfig {
    ...
    private static final String BOOKS_CONTACT_NAME = "Zair Ramos";
    private static final String BOOKS_CONTACT_URL = "github.com/profzairramos";
    private static final String BOOKS_CONTACT_EMAIL = "zair.ramos@gmail.com";
